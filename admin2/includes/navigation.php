        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav  mb-2 mb-lg-0 ms-auto">
                ...
                <li class="nav-item dropdown">
                    <a href="" class="d-none d-lg-none d-md-block text-decoration-none border border-warning rounded-pill text-center">Logout</a>
                    <button class="user d-lg-block d-md-none  " type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false ">
